...
async function handleMessage(msg) {
  ...
  if (text.startsWith("/start")) {
    ...
    const welcomeText =
      `👋 **Добро пожаловать в Лабубу Empire!**\n\n` +
      `🪙 **Суть игры:** тапай по учителям и зарабатывай деньги!\n` +
      ...
      `Нажми кнопку ниже, чтобы начать играть прямо сейчас:`;
    ...
    const helpText =
      ...
      `1. **Тапай** по Лабубу в центре экрана и зарабатывай рубли.\n` +
      `2. **Улучшай персонажа и запасы энергии** в меню улучшений.\n` +
