...
export const LEVELS: LevelConfig[] = [
  {
    ...
    description: "Миллиардер, плейбой, филантроп, который устал от богатой жизни и ушел работать в школу",
  },
  {
    level: 2,
    name: "Английский Лабубу",
    image: "/images/2lvl.png",
    minBalanceToUnlock: 10000,
    baseClickPower: 5,
    ...
    description: "Учитель английского в школе, по совместительству - гендиректор дуолинго",
  },
  {
    level: 3,
    name: "Инфо Лабубу",
    image: "/images/3lvl.png",
    minBalanceToUnlock: 100000,
    baseClickPower: 25,
    ...
    description: "Всеми силами пытается доказать, что он информатик, однако мы знаем правду.",
  },
  {
    level: 4,
    name: "Гео Лабубу",
    image: "/images/4lvl.png",
    minBalanceToUnlock: 1000000,
    baseClickPower: 120,
    ...
    description: "Магеллан, Колумб, Веспуччи плавали по ее туристическим маршрутам",
  },
  {
    level: 5,
    name: "Химический Лабубу",
    image: "/images/5lvl.png",
    minBalanceToUnlock: 10000000,
    baseClickPower: 600,
    ...
    description: "Обычный учитель химии. На переменах выводит формулу лекарства от рака",
  },
  {
    level: 6,
    name: "ОБЖ Лабубу",
    image: "/images/6lvl.png",
    minBalanceToUnlock: 100000000,
    baseClickPower: 3000,
    ...
    description: "Вместе с Трампом сбросил на Иран несколько килограмм демократических подарков",
  },
  {
    level: 7,
    name: "Исторический Лабубу",
    image: "/images/7lvl.png",
    minBalanceToUnlock: 1000000000,
    ...
    description: "Древнее зло, изгнанное Гераклом в самое подходящее ему место - кабинет 4305",
  },
];

export const FLOOR_CONFIGS = [
  { floor: 1, unlockCost: 3000, baseIncomePerDrop: 2, name: "Этаж 1" },
  { floor: 2, unlockCost: 50000, baseIncomePerDrop: 15, name: "Этаж 2" },
  { floor: 3, unlockCost: 600000, baseIncomePerDrop: 80, name: "Этаж 3" },
  { floor: 4, unlockCost: 5000000, baseIncomePerDrop: 450, name: "Этаж 4" },
  { floor: 5, unlockCost: 50000000, baseIncomePerDrop: 2500, name: "Этаж 5" },
  { floor: 6, unlockCost: 500000000, baseIncomePerDrop: 15000, name: "Этаж 6" },
  { floor: 7, unlockCost: 5000000000, baseIncomePerDrop: 100000, name: "Этаж 7" },
];
